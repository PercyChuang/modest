...
##########################################################################################
JAVA_OPTS="$JAVA_OPTS -server -Xms3550m -Xmx3550m -Xmn1024m -XX:PermSize=256m -XX:MaxPermSize=256m -Xss256k"
JAVA_OPTS="$JAVA_OPTS -XX:+UseParNewGC -XX:ParallelGCThreads=20 -XX:MaxTenuringThreshold=15 -XX:SurvivorRatio=8 -XX:+ScavengeBeforeFullGC"
JAVA_OPTS="$JAVA_OPTS -XX:+UseConcMarkSweepGC -XX:-CMSParallelRemarkEnabled -XX:+CMSClassUnloadingEnabled"
JAVA_OPTS="$JAVA_OPTS -XX:+CMSIncrementalMode -XX:+CMSIncrementalPacing -XX:CMSIncrementalDutyCycleMin=0 -XX:CMSIncrementalDutyCycle=10"
JAVA_OPTS="$JAVA_OPTS -XX:+UseCMSInitiatingOccupancyOnly -XX:CMSInitiatingOccupancyFraction=60"
JAVA_OPTS="$JAVA_OPTS -XX:+UseCMSCompactAtFullCollection -XX:CMSFullGCsBeforeCompaction=0"
JAVA_OPTS="$JAVA_OPTS -XX:+UseFastAccessorMethods -XX:GCTimeRatio=19 -XX:+DisableExplicitGC -XX:SoftRefLRUPolicyMSPerMB=0"
JAVA_OPTS="$JAVA_OPTS -XX:+PrintGC -XX:+PrintHeapAtGC -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintGCCause"
