...
import com.demo.dao.ScheduleJobDOMapper;
...
public class ScheduleJobService {
	...
	public ScheduleJobDO test() {
		...
		//采用执行器的方式来查询数据
		List<ScheduleJobDO> useSession = reuseSqlSession.selectList("com.demo.dao.ScheduleJobDOMapper.queryAll", null, new RowBounds(0,10));
